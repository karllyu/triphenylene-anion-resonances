...
# Path to the source file for anion_ref_geom
source_file = BASE_DIR / "anion_ref_geom/tri_cc-pvdz+3p_anion_ref_expd.csv"
...
mappings = [
    (BASE_DIR / "anion_ref_geom/A2_res1.csv", "1/A2"),
    (BASE_DIR / "anion_ref_geom/A2_res2.csv", "2/A2"),
    (BASE_DIR / "anion_ref_geom/A2_res3.csv", "3/A2"),
    (BASE_DIR / "anion_ref_geom/B2_res1.csv", "1/B2"),
    (BASE_DIR / "anion_ref_geom/B2_res2.csv", "2/B2"),
    (BASE_DIR / "anion_ref_geom/B2_res3.csv", "3/B2"),
]

# Process each res file in anion_ref_geom subfolder
